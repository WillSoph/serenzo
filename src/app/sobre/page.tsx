...
const title = "Sobre a Previsiva | Missão, equipe e princípios";
const description = "Somos apaixonados por bem-estar e tecnologia. Conheça nossa missão e o que nos guia na Previsiva.";
...
export default function SobrePage() {
  return (
    ...
    <main className="max-w-3xl mx-auto px-4 py-16">
      ...
      <h1 className="text-3xl md:text-4xl font-bold text-emerald-900">Sobre a Previsiva</h1>
      <p className="mt-3 text-slate-700">
        Criamos a Previsiva para transformar como empresas cuidam da saúde emocional de seus times.
      </p>
