...
// Conteúdo de exemplo — troque pelo seu CMS/MDX depois.
const posts = [
  {
...
// Metadata por slug (sem usar tipos externos)
export function generateMetadata(
  ...
  const description =
    post?.excerpt ?? "Conteúdos sobre bem-estar corporativo e produtividade.";
