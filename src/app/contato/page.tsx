...
export default function ContatoPage() {
  return (
    ...
    <main className="max-w-2xl mx-auto px-4 py-16">
      ...
      <p className="mt-3 text-slate-700">Envie um e-mail para <a className="underline text-emerald-700" href="mailto:contato@previsiva.com.br">contato@previsiva.com.br</a> ou fale no WhatsApp.</p>
      <ul className="mt-4 space-y-2 text-slate-700">
        <li><a className="underline text-emerald-700" href="https://wa.me/5511939298907" target="_blank">WhatsApp comercial</a></li>
        <li><a className="underline text-emerald-700" href="https://www.linkedin.com/company/sistema-previsiva" target="_blank">LinkedIn</a></li>
        <li><a className="underline text-emerald-700" href="https://www.instagram.com/sistema.previsiva" target="_blank">Instagram</a></li>
      </ul>
    </main>
    <Footer/>
    </>
